...
export const CarrierShip = (props) => (
    ...
    >
        ...
        <rect
            ...
            fill="#00D9FF"
            opacity="1"
            className={styles.elevatorPulse}
        />
        <rect
            x="250"
            y="48"
        ...
        {/* Bow detail */}
        <polygon
            points="485,58 490,62 495,52 490,48"
            opacity="0.7"
            fill="#FF6B35"
        />
    </svg>
...
export const Destroyer = (props) => (
    ...
    >
        ...
        <polygon
            points="120,52 135,30 175,30 190,52"
            fill="#0d0d0d"
            opacity="0.95"
            className={styles.stealthPulse}
        />
        <polygon
            points="140,30 145,20 165,20 170,30"
            fill="#0d0d0d"
            opacity="0.9"
        />
        ...
        <g opacity="0.95">
            <polygon
                points="50,52 60,42 75,42 80,52"
                fill="#2a2a2a"
                filter="url(#destroyerGlow)"
            />
            <rect
...
export const Submarine = (props) => (
    ...
    >
        ...
        {/* Nose cone */}
        <path
            d="M15,65 Q5,65 3,65 L15,55 L15,75 Z"
            fill="#0d0d0d"
            opacity="0.95"
        />
        ...
        {/* Conning tower */}
        <path
            d="M120,65 L125,35 L135,30 L175,30 L185,35 L190,65 Z"
            fill="#0a0a0a"
            opacity="0.95"
        />
        ...
        {/* Rudders - Animated */}
        <polygon
            points="285,55 290,50 295,55"
            fill="#0d0d0d"
            opacity="0.8"
            className={styles.rudderMove}
        />
        <polygon
            points="285,75 290,80 295,75"
            fill="#0d0d0d"
            opacity="0.8"
            className={styles.rudderMove}
        />
...
export const PatrolBoat = (props) => (
    ...
    >
        ...
        {/* Cabin/Bridge */}
        <polygon
            points="100,55 110,35 160,35 168,55"
            fill="#0d0d0d"
            opacity="0.95"
        ...
        <g opacity="0.95">
            <polygon
                points="45,55 52,48 60,48 65,55"
                fill="#2a2a2a"
                filter="url(#patrolGlow)"
            />
            <rect
